...
static inline uint8_t si570_get_hsdiv(void){
    return (si570_registers[0]>>5) + 4;
}

static inline void si570_set_hsdiv(uint8_t hsdiv){
...
static inline uint8_t si570_get_n1(void){
    uint8_t n1;
...
static inline void si570_set_n1(uint8_t n1){
...
static inline uint32_t si570_get_rfreq_truncated(void){
    uint32_t retval;
...
static inline void si570_set_rfreq_truncated(uint32_t rfreq){
